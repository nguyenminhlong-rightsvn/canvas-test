...
class HeapApi {
  Future<bool> track(String event,
    ...
    final encrypter =
        encrypt.Encrypter(encrypt.AES(encrypt.Key.fromUtf8(ENCRYPT_KEY)));
    final encryptedId =
        encrypter.encrypt(userId, iv: encrypt.IV.fromUtf8(ENCRYPT_IV)).base64;
