...
void setupLocator() {
  ...
  // Interactors
  locator.registerFactory<AcceptableUsePolicyInteractor>(
      () => AcceptableUsePolicyInteractor());
  locator.registerFactory<AccountCreationInteractor>(
      () => AccountCreationInteractor());
  locator.registerFactory<AlertsInteractor>(() => AlertsInteractor());
  locator.registerFactory<AlertThresholdsInteractor>(
      () => AlertThresholdsInteractor());
  locator.registerFactory<AnnouncementDetailsInteractor>(
      () => AnnouncementDetailsInteractor());
  locator.registerFactory<AttachmentFetcherInteractor>(
      () => AttachmentFetcherInteractor());
  locator.registerFactory<AssignmentDetailsInteractor>(
      () => AssignmentDetailsInteractor());
  locator.registerFactory<AttachmentPickerInteractor>(
      () => AttachmentPickerInteractor());
  locator.registerFactory<AudioVideoAttachmentViewerInteractor>(
      () => AudioVideoAttachmentViewerInteractor());
  locator.registerFactory<CalendarFilterListInteractor>(
      () => CalendarFilterListInteractor());
  locator.registerFactory<ConversationDetailsInteractor>(
      () => ConversationDetailsInteractor());
  locator.registerFactory<ConversationListInteractor>(
      () => ConversationListInteractor());
  locator.registerFactory<ConversationReplyInteractor>(
      () => ConversationReplyInteractor());
  locator.registerFactory<CourseDetailsInteractor>(
      () => CourseDetailsInteractor());
  locator.registerFactory<CoursesInteractor>(() => CoursesInteractor());
  locator.registerFactory<CreateConversationInteractor>(
      () => CreateConversationInteractor());
  locator.registerFactory<CourseRoutingShellInteractor>(
      () => CourseRoutingShellInteractor());
  locator.registerFactory<DashboardInteractor>(() => DashboardInteractor());
  locator
      .registerFactory<DomainSearchInteractor>(() => DomainSearchInteractor());
  locator.registerFactory<ErrorReportInteractor>(() => ErrorReportInteractor());
  locator
      .registerFactory<EventDetailsInteractor>(() => EventDetailsInteractor());
  locator.registerFactory<HelpScreenInteractor>(() => HelpScreenInteractor());
  locator.registerFactory<ManageStudentsInteractor>(
      () => ManageStudentsInteractor());
  locator.registerFactory<MasqueradeScreenInteractor>(
      () => MasqueradeScreenInteractor());
  locator.registerFactory<PairingInteractor>(() => PairingInteractor());
  locator.registerFactory<QRLoginTutorialScreenInteractor>(
      () => QRLoginTutorialScreenInteractor());
  // locator
  //     .registerFactory<RemoteConfigInteractor>(() => RemoteConfigInteractor());
  locator.registerFactory<SettingsInteractor>(() => SettingsInteractor());
  locator
      .registerFactory<SplashScreenInteractor>(() => SplashScreenInteractor());
  locator.registerFactory<StudentColorPickerInteractor>(
      () => StudentColorPickerInteractor());
  locator.registerFactory<ViewAttachmentInteractor>(
      () => ViewAttachmentInteractor());
  ...
  locator
      .registerLazySingleton<AndroidIntentVeneer>(() => AndroidIntentVeneer());
  locator.registerLazySingleton<BarcodeScanVeneer>(() => BarcodeScanVeneer());
  locator.registerLazySingleton<FlutterDownloaderVeneer>(
      () => FlutterDownloaderVeneer());
  locator.registerLazySingleton<FlutterSnackbarVeneer>(
      () => FlutterSnackbarVeneer());
  ...
  locator.registerLazySingleton<CalendarTodayClickNotifier>(
      () => CalendarTodayClickNotifier());
  ...
  locator.registerLazySingleton<StudentAddedNotifier>(
